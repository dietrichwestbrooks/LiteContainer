...
<<<<<<< HEAD
        ...
        public ContainerRegistration Register<TService>(Func<object[], TService> factory)
        {
            if (factory == null)
                throw new ArgumentNullException("factory");
        ...
        public ContainerRegistration Register<TService>(Func<object[], TService> factory, string name)
        {
            if (factory == null)
                throw new ArgumentNullException("factory");
